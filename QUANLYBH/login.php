...
if(isset($_POST['submit'])){
    ...
    if(isset($taiKhoan)&&isset($pass)){
        $sql = "SELECT * FROM tblnhanvien WHERE taiKhoan = '$taikhoan' && matKhau = '$password'";
        $query = mysqli_query($con,$sql);
        $row = mysqli_num_rows($query);
        if($row>0){
            $_SESSION["username"] = $taikhoan;
            $_SESSION["current-password"] = $password;
            header('location: ./doc/index.php');
        }else{
            echo '<center class= "alert alert-danger">Tai khoan khong ton tai hoac sai';
        }
                ...
                <form class="login100-form validate-form">
                    ...
                    <form action="">
                        <div class="wrap-input100 validate-input">
                            <input class="input100" type="taikhoan" placeholder="Tài khoản quản trị" name="username"
                                id="username">
                        ...
                        <div class="text-right p-t-12">
                            <a class="txt2" href="/QUANLYBH/forgot.php">
                                Bạn quên mật khẩu?
                            </a>
                        </div>
                    </form>
                    ...
                    <div class="text-center p-t-70 txt2">
                        ...
                        <script type="text/javascript">document.write(new Date().getFullYear());</script> <a
                            class="txt2" href=""> nhóm Hợp Hoan Tông </a>
                    </div>
                </form>
            </div>
        </div>
